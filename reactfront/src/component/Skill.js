...
const Skill = () => {
    ...
    useEffect(() => {
        ...
        if (elHeight3 === 1169) {
            if (scrollPosition <= 130 || scrollPosition > 2128) {
                setData(true)
            } else {
                setData(false)
            }

        } else if (elHeight3 === 1257) {
            if (scrollPosition <= 90 || scrollPosition >= 2300) {
                console.log(scrollPosition)
                setData(true)
            } else {
                setData(false)
            }
        } else if (elHeight3 === 1666) {
            if (scrollPosition <= 200 || scrollPosition > 2800) {
               
                setData(true)
            } else {
                setData(false)
            }
        } else if (elHeight3 === 2749) {
            if (scrollPosition < 300 || scrollPosition > 3800) {
                setData(true)
            } else {
                setData(false)
            }
    ...
    return (
        <div id="3" className="SkillContainer">
            ...
            <div className="SkillItemsContainer">
                <Fade spy={data}>
                    <div className="SkillContentMargin">
